...
public class ExprCommandPermission extends SimpleExpression<String> {
	
	static {
		Skript.registerExpression(
				ExprCommandPermission.class, String.class, ExpressionType.SIMPLE, 
				"[the] permission (holding|of) [command] %string%");
	}
	...
	public String toString(@Nullable Event arg0, boolean arg1) {
		return "[the] name of [the] permission (holding|of) [command] %string%";
	}
